...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p>Thank you for your order from  <strong><a href="https://dragonautomart.com/store/{{ $shop->name }}/{{ $shop->id }}">{{ $shop->name }}!</a></strong> We wanted to let you know that your order <strong>#{{ $order->id }}</strong> was shipped via {{ $TrackingOrder->courier_name }}, on {{ $date }}.</p>

...
class HomeController extends Controller
{
    ...
    {
        $Products = Product::with('user','category','brand','model','stock','discount','tax','shipping','deal.deal_product','wholesale','shop','reviews.user','product_varient')->where('published',1)->get();

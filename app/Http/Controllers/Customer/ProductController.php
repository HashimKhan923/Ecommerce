...
class ProductController extends Controller
{
    ...
    public function chat(Request $request)
    {
            ...
            // System prompt — defining AutoGenie and product-prompt behavior
            $systemMessage = [
                'role' => 'system',
        ...
        At the end of each reply, include a JSON object with available filters like: {"make":"Honda","model":"Civic","year":2016,"part":"tail light","max_price":100}. All fields are optional.'
            ...
            // Only apply filters and search if newFilters contains meaningful product data
            if (!empty($newFilters) && (

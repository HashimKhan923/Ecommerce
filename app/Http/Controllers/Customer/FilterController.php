...
class FilterController extends Controller
{
    public function search(Request $request)
    {
        ...
        {
            $data = Product::with('user','category','brand','model','stock','product_varient','discount','tax','shipping','deal.deal_product','wholesale')
    ...
    public function multiSearch(Request $request)
    {
        ...
        $data = $query->with('user','category','brand','model','stock','product_varient','discount','tax','shipping','deal.deal_product','wholesale')->where('published',1)->get();

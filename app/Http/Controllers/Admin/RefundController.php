...
class RefundController extends Controller
{
    ...
    {
        $data = Refund::with('order.order_detail.products.shop')->get();
    ...
    public function paypal_refund(Request $request)
    {
        ...
        Notification::create([
            'customer_id' => $user->id,
            'notification' => 'your #'.$Order->id.' refund request has been fulfield by admin and you will receive your amount in 5 to 10 working days.',
        ]);

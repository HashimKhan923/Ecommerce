...
class OrderController extends Controller
{
    ...
    {
        $data = Order::with('order_detail.products.product_gallery','shop','order_timeline','order_detail.products.category','order_detail.products.brand','order_detail.products.model','order_detail.products.stock','order_detail.varient','order_detail.products.reviews.user','order_detail.products.tax','order_detail.products.shop.shop_policy','order_status','coupon_user.coupon','order_tracking','order_refund')->get();

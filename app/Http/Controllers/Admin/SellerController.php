...
class SellerController extends Controller
{
    ...
    {
        $Sellers = User::with('my_customers','time_line','seller_order.order_timeline','seller_order.order_refund','stafs','shop.shop_policy','seller_information','SellingPlatforms','SocialPlatforms','BankDetail','CreditCard')->where('user_type','seller')->get();
